      ...
      >
        <div className="freelancer-overview">
          ...
          <div className="freelancer-name">
            <h4>
              <Link to={{ pathname: `/candidato/${props.id}` }}>
          ...
          <div className="freelancer-details-list">
            ...
            >
              <li>
                ...
                <strong>{props.ciudad}</strong>
              </li>
              <li>
                <i className="icon-material-outline-location-on"></i> Sueldo{" "}
                <strong>
                  ${props.sueldoMin} ${props.sueldoMax} $
                </strong>
              </li>
              <li>
                <i className="icon-material-outline-location-on"></i> Titulo{" "}
                <strong>{props.titulo}</strong>
              </li>
            </ul>
          </div>
          <Link
            to={{ pathname: `/candidato/${props.id}` }}
