      ...
      <div className="sidebar-container">
        ...
        <div className="sidebar-widget">
          ...
          <select
            ...
            data-size="7"
            title="Todas"
            onChange={props.filtroEstudios}
          >
            <option value="">Seleccionar Profesión</option>
            <option value="Ingeniero Civil">Ingeniero Civil</option>
            <option value="Ingeniero informatico">Ingeniero Informatico</option>
            <option value="Laboratorista de concreto">Laboratorista</option>
            ...
            <option value="Licenciado en Derecho">Licenciado en Derecho</option>
          </select>
        </div>
          ...
          <div className="switches-list">
            <div className="switch-container">
              <label className="switch">
                <input
                  type="checkbox"
                  onChange={props.filtroTipo}
                  value="Por Temporada"
                />
                <span className="switch-button"></span> Por Temporada
              </label>
            </div>
          </div>
          <div className="switches-list">
            <div className="switch-container">
              <label className="switch">
                ...
                />
                <span className="switch-button"></span> Tiempo Completo
              </label>
            </div>
          </div>
          <div className="switches-list">
            <div className="switch-container">
              <label className="switch">
                <input
                  ...
                  value="Medio Tiempo"
                />
                <span className="switch-button"></span> Medio Tiempo
              </label>
            </div>
          </div>
            ...
            <div className="switch-container">
              <label className="switch">
                <input
                  ...
                  value="Temporal"
                />
                <span className="switch-button"></span> Temporal
              </label>
            </div>
          </div>
        </div>
          ...
          <div className="keywords-container">
            <div className="keyword-input-container">
              <input
                ...
                placeholder="e.g. Ingeniero Civil"
              />
